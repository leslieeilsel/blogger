 ...
 * Generated for Laravel 5.1.46 (LTS) on 2017-08-29.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class DB {
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \October\Rain\Database\Connections\MySqlConnection::selectOne($query, $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \October\Rain\Database\Connections\MySqlConnection::transaction($callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            \October\Rain\Database\Connections\MySqlConnection::rollBack();
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \October\Rain\Database\Connections\MySqlConnection::getFetchMode();
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \October\Rain\Database\Connections\MySqlConnection::setFetchMode($fetchMode);
        }
...
namespace RainLab\User\Facades {
    ...
    class Auth {
        ...
        {
            return \RainLab\User\Classes\AuthManager::init();
        }
        ...
        public static function extendUserQuery($query)
        {
            return \RainLab\User\Classes\AuthManager::extendUserQuery($query);
        }
        ...
        public static function login($user, $remember = true)
        {
            return \RainLab\User\Classes\AuthManager::login($user, $remember);
        }
        ...
        {
            return \RainLab\User\Classes\AuthManager::findGuestUserByCredentials($credentials);
        }
        ...
        {
            return \RainLab\User\Classes\AuthManager::findGuestUser($email);
        }
        ...
        {
            return \RainLab\User\Classes\AuthManager::registerGuest($credentials);
        }
        ...
        {
            return \RainLab\User\Classes\AuthManager::convertGuestToUser($user, $credentials, $activate);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \RainLab\User\Classes\AuthManager::createUserModel();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \RainLab\User\Classes\AuthManager::getUser();
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \RainLab\User\Classes\AuthManager::findUserById($id);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \RainLab\User\Classes\AuthManager::findUserByLogin($login);
        }
        ...
        {
            //Method inherited from \October\Rain\Auth\Manager            
            return \RainLab\User\Classes\AuthManager::logout();
        }
